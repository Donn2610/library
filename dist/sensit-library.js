...
function Wt() {
  if (st)
    return g;
  st = 1;
  var H = Symbol.for("react.element"), v = Symbol.for("react.portal"), ye = Symbol.for("react.fragment"), G = Symbol.for("react.strict_mode"), se = Symbol.for("react.profiler"), re = Symbol.for("react.provider"), te = Symbol.for("react.context"), Q = Symbol.for("react.forward_ref"), $ = Symbol.for("react.suspense"), Z = Symbol.for("react.memo"), L = Symbol.for("react.lazy"), V = Symbol.iterator;
  function ee(n) {
  ...
  he.constructor = I, ce(he, ne.prototype), he.isPureReactComponent = !0;
  var oe = Array.isArray, N = Object.prototype.hasOwnProperty, z = { current: null }, fe = { key: !0, ref: !0, __self: !0, __source: !0 };
  function pe(n, s, h) {
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        _[C] === void 0 && (_[C] = T[C]);
    return { $$typeof: H, type: n, key: P, ref: k, props: _, _owner: z.current };
  }
  function Re(n, s) {
  ...
  function J(n, s, h, C, _) {
    ...
    if (k)
      return k = n, _ = _(k), n = C === "" ? "." + q(k, 0) : C, oe(_) ? (h = "", n != null && (h = n.replace(we, "$&/") + "/"), J(_, s, h, "", function(W) {
        return W;
    ...
    if (k = 0, C = C === "" ? "." : C + ":", oe(n))
      ...
      for (n = w.call(n), T = 0; !(P = n.next()).done; )
        P = P.value, w = C + q(P, T++), k += J(P, s, h, w, _);
    else if (P === "object")
  ...
  var d = { current: null }, le = { transition: null }, Se = { ReactCurrentDispatcher: d, ReactCurrentBatchConfig: le, ReactCurrentOwner: z };
  return g.Children = { map: U, forEach: function(n, s, h) {
    ...
    return n;
  } }, g.Component = ne, g.Fragment = ye, g.Profiler = se, g.PureComponent = I, g.StrictMode = G, g.Suspense = $, g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Se, g.cloneElement = function(n, s, h) {
    if (n == null)
    ...
    return { $$typeof: H, type: n.type, key: _, ref: P, props: C, _owner: k };
  ...
  return ct || (ct = 1, function(H, v) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      function _r(e, r, a) {
        ...
        return je(e, p, l, y, E, z.current, i);
      }
      function br(e, r) {
      ...
      function Er(e, r, a) {
        ...
        if (r != null) {
          Ye(r) && (l = r.ref, O = z.current), ge(r) && (Oe(r.key), p = "" + r.key);
          var j;
      ...
      function be(e, r, a, o, i) {
        ...
        if (l) {
          ...
          if (Fe(E)) {
            var j = "";
            O != null && (j = ve(O) + "/"), be(E, r, j, "", function(Mt) {
              return Mt;
            });
          } else
        ...
        if (Fe(e))
          for (var vr = 0; vr < e.length; vr++)
            A = e[vr], D = B + Ae(A, vr), M += be(A, r, a, D, i);
        else {
          var Lr = I(e);
          if (typeof Lr == "function") {
            ...
            for (var Lt = Lr.call(ot), ut, Nt = 0; !(ut = Lt.next()).done; )
              A = ut.value, D = B + Ae(A, Nt++), M += be(A, r, a, D, i);
          } else if (p === "object") {
            var it = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === re || e === Q || J || e === te || e === V || e === ee || q || e === Ie || Ce || Ue || we || typeof e == "object" && e !== null && (e.$$typeof === ce || e.$$typeof === K || e.$$typeof === $ || e.$$typeof === Z || e.$$typeof === L || // This needs to include all possible module reference object
...
Check the top-level render call using <` + a + ">.");
      ...
      function rt(e, r, a) {
        ...
        if (!o) {
          ...
          p ? i += p : i += Jr();
          var l;
          e === null ? l = "null" : Fe(e) ? l = "array" : e !== void 0 && e.$$typeof === G ? (l = "<" + (de(e.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : l = typeof e, d("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", l, i);
        }
      ...
      function At(e) {
        if (dr === null)
          try {
            ...
            dr = a.call(H, "timers").setImmediate;
          } catch {
            dr = function(i) {
      ...
      v.Children = $t, v.Component = _, v.Fragment = re, v.Profiler = Q, v.PureComponent = W, v.StrictMode = te, v.Suspense = V, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, v.cloneElement = It, v.createContext = ur, v.createElement = Dt, v.createFactory = Ft, v.createRef = hr, v.forwardRef = kr, v.isValidElement = _e, v.lazy = Pr, v.memo = c, v.startTransition = jt, v.unstable_act = xt, v.useCallback = X, v.useContext = R, v.useDebugValue = ie, v.useDeferredValue = yt, v.useEffect = Y, v.useId = ht, v.useImperativeHandle = ir, v.useInsertionEffect = x, v.useLayoutEffect = F, v.useMemo = Ee, v.useReducer = b, v.useRef = m, v.useState = S, v.useSyncExternalStore = mt, v.useTransition = vt, v.version = ye, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function Ut() {
  if (lt)
    return He;
  lt = 1;
  var H = pt(), v = Symbol.for("react.element"), ye = Symbol.for("react.fragment"), G = Object.prototype.hasOwnProperty, se = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, $, Z) {
    var L, V = {}, ee = null, K = null;
    Z !== void 0 && (ee = "" + Z), $.key !== void 0 && (ee = "" + $.key), $.ref !== void 0 && (K = $.ref);
    for (L in $)
      G.call($, L) && !re.hasOwnProperty(L) && (V[L] = $[L]);
    if (Q && Q.defaultProps)
      for (L in $ = Q.defaultProps, $)
        V[L] === void 0 && (V[L] = $[L]);
    return { $$typeof: v, type: Q, key: ee, ref: K, props: V, _owner: se.current };
  }
  return He.Fragment = ye, He.jsx = te, He.jsxs = te, He;
}
var Ge = {};
/**
 * @license React
...
function Yt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    var H = pt(), v = Symbol.for("react.element"), ye = Symbol.for("react.portal"), G = Symbol.for("react.fragment"), se = Symbol.for("react.strict_mode"), re = Symbol.for("react.profiler"), te = Symbol.for("react.provider"), Q = Symbol.for("react.context"), $ = Symbol.for("react.forward_ref"), Z = Symbol.for("react.suspense"), L = Symbol.for("react.suspense_list"), V = Symbol.for("react.memo"), ee = Symbol.for("react.lazy"), K = Symbol.for("react.offscreen"), ce = Symbol.iterator, Ie = "@@iterator";
    function ne(t) {
    ...
    var ae = H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function I(t) {
      {
    ...
    var oe = !1, N = !1, z = !1, fe = !1, pe = !1, Re;
    Re = Symbol.for("react.module.reference");
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === G || t === re || pe || t === se || t === Z || t === L || fe || t === K || oe || N || z || typeof t == "object" && t !== null && (t.$$typeof === ee || t.$$typeof === V || t.$$typeof === te || t.$$typeof === Q || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var J = Object.assign, U = 0, ue, d, le, Se, n, s, h;
    function C() {
    }
    ...
    function Cr(t, u, c, f, R) {
      {
        ...
        return Rr(t, m, Y, R, f, ge.current, b);
      }
    }
...
Check the top-level render call using <` + c + ">.");
    ...
    function ze(t, u, c, f, R, S) {
      {
        ...
        if (!b) {
          ...
          Y ? m += Y : m += xe();
          var x;
          t === null ? x = "null" : Le(t) ? x = "array" : t !== void 0 && t.$$typeof === v ? (x = "<" + (q(t.type) || "Unknown") + " />", m = " Did you accidentally export a JSX literal instead of a component?") : x = typeof t, I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", x, m);
        }
        var F = Cr(t, u, c, R, S);
        if (F == null)
          return F;
    ...
    var Pr = Or, kr = Tr;
    Ge.Fragment = G, Ge.jsx = Pr, Ge.jsxs = kr;
  }()), Ge;
}
...
const zt = Bt.jsx, qt = ({
  ...
  textColor: G,
  backgroundColor: se
}) => /* @__PURE__ */ zt("div", { children: "Hello" });
export {
  qt as CustomCarousel
};
